...
// repo root:
//
//	mise exec -- sh -c 'protoc --proto_path=contract --go_out=. --go_opt=module=github.com/MatchaScript/nanokube contract/desired.proto'
package desiredpb

//go:generate sh -c "cd ../.. && protoc --proto_path=contract --go_out=. --go_opt=module=github.com/MatchaScript/nanokube contract/desired.proto"
